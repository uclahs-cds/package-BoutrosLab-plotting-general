...
static double R_jaccard(double *x, int nr, int nc, int i1, int i2)
{
	double total, both, numer, denom;
    int j;
...
enum { EUCLIDEAN=1, MAXIMUM, MANHATTAN, CANBERRA, BINARY, MINKOWSKI, JACCARD };
